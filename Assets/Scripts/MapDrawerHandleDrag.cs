...
public class MapDrawerHandleDrag : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    [SerializeField] private MapDrawerController controller;
